...
const std::string& cpp_generator::generate_cpp_output(const enumbra_config& cfg, const enumbra::enum_meta_config& enum_meta)
{
	...
	write_line("// THIS FILE WAS GENERATED BY A TOOL");
    ...
    write_line("// You can support: https://github.com/Scaless/enumbra");
...
#error An included header was generated using an older version of enumbra. Regenerate your headers using same version of enumbra.
	...
	{
		write_line_tabbed(1, "constexpr ::enumbra::from_wstring_result<T> from_wstring(const wchar_t* str, ::std::uint32_t len) = delete;");
	}
	else
	{
		write_line_tabbed(1, "constexpr ::enumbra::from_string_result<T> from_string(const char* str, ::std::uint32_t len) = delete;");
	}
