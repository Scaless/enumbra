...
// Generated by enumbra v0.0.5 on Sun Jan  2 16:13:43 2022
...
namespace enumbra {
    namespace detail {
        ...
        template<class T> constexpr bool streq(T* a, T* b) {
...
struct test_value {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC test_value::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
        }
        success = false;
...
struct HexDiagonal {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC HexDiagonal::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct NegativeTest1 {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC NegativeTest1::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct NegativeTest2 {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC NegativeTest2::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct NegativeTest3 {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC NegativeTest3::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct NegativeTest4 {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC NegativeTest4::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct EmptyTest1Unsigned {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC EmptyTest1Unsigned::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct EmptyTest1Signed {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC EmptyTest1Signed::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct SingleTest1Unsigned {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC SingleTest1Unsigned::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct SingleTest1Signed {
    ...
    static ENUMBRA_CONSTEXPR_NONCONSTFUNC SingleTest1Signed::Value from_string(const char* str, bool& success) {
        for (std::size_t i = 0; i < string_lookup_.size(); i++) {
            if (enumbra::detail::streq(string_lookup_[i].second, str) == 0) {
                return string_lookup_[i].first;
            }
...
struct test_flags {
    ...
    ENUMBRA_CONSTEXPR_NONCONSTFUNC bool single() const { uint32_t n = static_cast<uint32_t>(value_); return n && !(n & (n - 1)); }
...
constexpr test_flags::Value operator&(const test_flags::Value a, const test_flags::Value b) { return static_cast<test_flags::Value>(static_cast<uint32_t>(a) & static_cast<uint32_t>(b)); }
constexpr test_flags::Value operator^(const test_flags::Value a, const test_flags::Value b) { return static_cast<test_flags::Value>(static_cast<uint32_t>(a) ^ static_cast<uint32_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator|=(test_flags::Value a, const test_flags::Value b) { a = static_cast<test_flags::Value>(static_cast<uint32_t>(a) | static_cast<uint32_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator&=(test_flags::Value a, const test_flags::Value b) { a = static_cast<test_flags::Value>(static_cast<uint32_t>(a) & static_cast<uint32_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator^=(test_flags::Value a, const test_flags::Value b) { a = static_cast<test_flags::Value>(static_cast<uint32_t>(a) ^ static_cast<uint32_t>(b)); }
...
struct test_nodefault {
    ...
    ENUMBRA_CONSTEXPR_NONCONSTFUNC bool single() const { uint16_t n = static_cast<uint32_t>(value_); return n && !(n & (n - 1)); }
...
constexpr test_nodefault::Value operator&(const test_nodefault::Value a, const test_nodefault::Value b) { return static_cast<test_nodefault::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
constexpr test_nodefault::Value operator^(const test_nodefault::Value a, const test_nodefault::Value b) { return static_cast<test_nodefault::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator|=(test_nodefault::Value a, const test_nodefault::Value b) { a = static_cast<test_nodefault::Value>(static_cast<uint16_t>(a) | static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator&=(test_nodefault::Value a, const test_nodefault::Value b) { a = static_cast<test_nodefault::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator^=(test_nodefault::Value a, const test_nodefault::Value b) { a = static_cast<test_nodefault::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
...
constexpr TestSparseFlags::Value operator&(const TestSparseFlags::Value a, const TestSparseFlags::Value b) { return static_cast<TestSparseFlags::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
constexpr TestSparseFlags::Value operator^(const TestSparseFlags::Value a, const TestSparseFlags::Value b) { return static_cast<TestSparseFlags::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator|=(TestSparseFlags::Value a, const TestSparseFlags::Value b) { a = static_cast<TestSparseFlags::Value>(static_cast<uint16_t>(a) | static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator&=(TestSparseFlags::Value a, const TestSparseFlags::Value b) { a = static_cast<TestSparseFlags::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator^=(TestSparseFlags::Value a, const TestSparseFlags::Value b) { a = static_cast<TestSparseFlags::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
...
constexpr TestSingleFlag::Value operator&(const TestSingleFlag::Value a, const TestSingleFlag::Value b) { return static_cast<TestSingleFlag::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
constexpr TestSingleFlag::Value operator^(const TestSingleFlag::Value a, const TestSingleFlag::Value b) { return static_cast<TestSingleFlag::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator|=(TestSingleFlag::Value a, const TestSingleFlag::Value b) { a = static_cast<TestSingleFlag::Value>(static_cast<uint16_t>(a) | static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator&=(TestSingleFlag::Value a, const TestSingleFlag::Value b) { a = static_cast<TestSingleFlag::Value>(static_cast<uint16_t>(a) & static_cast<uint16_t>(b)); }
ENUMBRA_CONSTEXPR_NONCONSTFUNC void operator^=(TestSingleFlag::Value a, const TestSingleFlag::Value b) { a = static_cast<TestSingleFlag::Value>(static_cast<uint16_t>(a) ^ static_cast<uint16_t>(b)); }
