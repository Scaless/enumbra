...
// Generated by enumbra v0.0.6 on Sun Jan  2 19:20:04 2022
...
struct test_nodefault {
    ...
    ENUMBRA_CONSTEXPR_NONCONSTFUNC bool is_single() const { uint16_t n = static_cast<uint32_t>(value_); return n && !(n & (n - 1)); }
