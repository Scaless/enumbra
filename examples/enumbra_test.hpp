...
// Generated by enumbra v0.0.4 on Wed Dec 29 19:38:09 2021
...
#elif (ENUMBRA_MACROS_VERSION + 0) < 2
...
#endif
#else
#define ENUMBRA_MACROS_VERSION 2
...
namespace enumbra {
    namespace detail {
        // Base templates for non-enumbra types
        template<class T>
    ...
    template<class T> inline constexpr bool is_enumbra_type_v = detail::enumbra_base_helper<T>::enumbra_type;
    template<class T> inline constexpr bool is_enumbra_struct_v = is_enumbra_type_v<T> && !detail::enumbra_base_helper<T>::enumbra_enum_class;
    template<class T> inline constexpr bool is_enumbra_scoped_enum_v = is_enumbra_type_v<T> && detail::enumbra_base_helper<T>::enumbra_enum_class;
    template<class T> inline constexpr bool is_enumbra_value_enum_v = is_enumbra_type_v<T> && detail::enumbra_base_helper<T>::enumbra_value_enum;
    template<class T> inline constexpr bool is_enumbra_flags_enum_v = is_enumbra_type_v<T> && detail::enumbra_base_helper<T>::enumbra_flags_enum;
...
struct test_value {
    ...
    constexpr void reset_default() { value_ = test_value(); }
    ...
    static constexpr bool contains(test_value v) { return (0 <= static_cast<int32_t>(v.value_)) && (static_cast<int32_t>(v.value_) <= 2); }
...
struct HexDiagonal {
    ...
    constexpr void reset_default() { value_ = HexDiagonal(); }
    ...
    static constexpr bool contains(HexDiagonal v) { return (0 <= static_cast<uint8_t>(v.value_)) && (static_cast<uint8_t>(v.value_) <= 5); }
...
struct test_flags {
    ...
    constexpr void reset_default() { *this = test_flags(); }
    constexpr void reset_zero() { value_ = static_cast<Value>(0); }
    constexpr bool test(Value v) const { return (static_cast<uint32_t>(value_) & static_cast<uint32_t>(v)) == static_cast<uint32_t>(v); }
    constexpr void unset(Value v) { value_ = static_cast<Value>(static_cast<uint32_t>(value_) & (~static_cast<uint32_t>(v))); }
    constexpr void flip(Value v) { value_ = static_cast<Value>(static_cast<uint32_t>(value_) ^ static_cast<uint32_t>(v)); }
    ...
    static constexpr bool contains(test_flags v) { return (0 <= static_cast<uint32_t>(v.value_)) && (static_cast<uint32_t>(v.value_) <= 3); }
...
struct test_nodefault {
    ...
    constexpr void reset_default() { *this = test_nodefault(); }
    constexpr void reset_zero() { value_ = static_cast<Value>(0); }
    constexpr bool test(Value v) const { return (static_cast<uint16_t>(value_) & static_cast<uint16_t>(v)) == static_cast<uint16_t>(v); }
    constexpr void unset(Value v) { value_ = static_cast<Value>(static_cast<uint16_t>(value_) & (~static_cast<uint16_t>(v))); }
    constexpr void flip(Value v) { value_ = static_cast<Value>(static_cast<uint16_t>(value_) ^ static_cast<uint16_t>(v)); }
    ...
    static constexpr bool contains(test_nodefault v) { return (0 <= static_cast<uint16_t>(v.value_)) && (static_cast<uint16_t>(v.value_) <= 3); }
